  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const [pr, cr] = await Promise.all([fetch('/api/products?limit=24&sort=popular'), fetch('/api/categories')])
